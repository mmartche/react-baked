 ...
 render () {
    ...
    if(this.state.errorValue) {
      errorSnackbarJSX = <Snackbar
        ...
        onRequestClose={ () => console.log('custom onClose code') } />;
    }
    ...
    if(userIsLoggedIn) {
      menuLinksJSX = (<span>
          ...
          <Link to='/logout'><RaisedButton label="Sair" style={buttonStyle}  /></Link> 
        </span>);
    } else {
      menuLinksJSX = (<span>
          <Link to='/register'><RaisedButton label="Registrar" style={buttonStyle}  /></Link> 
